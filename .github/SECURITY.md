...
[**Report a vulnerability**](https://github.com/hassio-addons/app-homebox/security/advisories/new)
...
- Issues in Homebox itself; please report those directly to the
  [Homebox project](https://github.com/sysadminsmedia/homebox/security/policy).
...
This security policy covers the Homebox app in this repository: the app
